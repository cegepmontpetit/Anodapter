...
CUDA_VISIBLE_DEVICES=1 python sample_anodapter.py --size 512 --num 1000 --step 100 --batch 8 --model_path $adapter_path --save_dir $path_to_the_save_dir --prompt_txt_path $path_to_generated_prompt_mapping.txt --adapter_path $adapter_path --anomaly_type $type_name
